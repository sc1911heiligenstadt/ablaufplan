...
function setupListeners() {
  ...
  // offen ist.
  // ⚠️ Der Takt läuft nach einem Sitzungsverlust weiter und würde die
  // eben geleerte Hülle wieder befüllen. Deshalb der Riegel.
  setInterval(() => { if (!bildschirmGeraeumt && offenerAblauf()) renderPunkte(); }, AUTO_REFRESH_MS);
}
