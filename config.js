...
// Was der Ablaufplan kann — steht im Info-Reiter als Karte "Funktionen".
// WICHTIG: Das ist NICHT der Changelog. Hier steht der ZUSTAND ("ein Knopf
// schiebt alles ab einer Stelle"), dort die Änderung ("ein Knopf schiebt
// JETZT alles ab einer Stelle"). Wer eine Funktion umbaut oder abschaltet,
// zieht diesen Text mit — und ebenso E:\SC1911-Tools-Anleitung.txt.
const APP_FUNKTIONEN = [
  {
    title: "Was ein Ablauf ist",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      "Punkte, die gleichzeitig laufen, stehen nebeneinander statt hintereinander.",
      "Eine rote Linie zeigt am laufenden Tag, wo gerade „jetzt“ ist. Was gelaufen ist, tritt zurück; was gerade läuft, ist umrandet.",
      "Darunter steht die Liste mit allen Angaben, Trainernamen und Knöpfen. Ein Tipp auf ein Kästchen springt zur passenden Zeile.",
  ...
  },
  {
    ...
    items: [
      ...
      "Die Ankreuzliste der Mannschaften kommt aus der zentralen Liste, die in der Tools-Übersicht unter Einstellungen → Mannschaften gepflegt wird.",
  ...
  },
  {
    ...
    items: [
      ...
      "Je Anhang gilt eine Obergrenze von 10 MB."
    ]
  }
];
